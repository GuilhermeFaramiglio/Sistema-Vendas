...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title : 'Caixa'; ?></title>
...
<div class="row">
    <div class="col-12">
        <h1 class="mb-4">
            <i class="bi bi-cart-plus"></i> Caixa - Nova Venda
        </h1>
    </div>
</div>
...
<form method="POST" action="" id="form-venda">
    ...
    <div class="row mt-4">
        <div class="col-12">
            ...
            <button type="button" class="btn btn-lg ms-2" style="background-color: #2494d1; color: #fff;" onclick="clearForm()">
