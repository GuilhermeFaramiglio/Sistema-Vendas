...
// Vendas Hoje
$hoje = date('Y-m-d');
$sqlVendasHoje = "SELECT COUNT(*) AS total FROM VENDA WHERE CAST(VEN_DATAVENDA AS DATE) = '$hoje'";
...
<div class="row mb-4">
    <div class="col-12">
        <h1 class="text-custom-primary">
            <i class="bi bi-speedometer2"></i> Dashboard - Visão Geral do Sistema
        </h1>
...
<div class="row mb-4">
    ...
    <div class="col-lg-6 col-md-12 mb-3">
        <div class="card content-card h-100">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="bi bi-bar-chart"></i> Vendas por Mês (12 meses)
                </h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-6 col-md-12 mb-3">
        <div class="card content-card h-100">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="bi bi-graph-up"></i> Faturamento Esperado (12 meses)
                </h5>
            </div>
            <div class="card-body">
...
new Chart(ctxVendas, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Vendas (R$)',
            data: dadosVendas,
            backgroundColor: 'rgba(139, 88, 67, 0.8)',
            borderColor: 'rgba(139, 88, 67, 1)',
            borderWidth: 1
        }]
    },
    options: {
...
new Chart(ctxFaturamento, {
    ...
    data: {
        ...
        datasets: [{
            ...
            borderColor: 'rgba(91, 72, 74, 1)',
            backgroundColor: 'rgba(91, 72, 74, 0.1)',
            borderWidth: 2,
            fill: true,
            tension: 0.4
        }]
