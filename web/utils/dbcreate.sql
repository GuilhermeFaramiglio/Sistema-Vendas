...
CREATE TABLE PRODUTO (
    ...
    PRO_DATACADASTRO DATE NOT NULL DEFAULT GETDATE(),
    PRO_TIPO VARCHAR(20) NOT NULL, -- Considerar futuramente tabela de tipos
...
CREATE TABLE VENDA (
    ...
    VEN_DATAVENDA DATETIME NOT NULL DEFAULT GETDATE(),
